...
# rc_range_parameters_8_10 = np.array([
#     [0, 8, 2],
#     [4, 8, 0],
#     [5, 9, 0],
#     [5, 10, -2],
...
# ])
#
# rc_range_parameters_8_12 = np.array([
#     [0, 12, 2],
#     [4, 12, 0],
#     [9, 13, 0],
#     [9, 14, -2],
...
# ])
#
# rc_range_parameters_12_8 = np.array([
#     [0, 2, 0],
#     [0, 4, 0],
#     [1, 5, 0],
#     [1, 6, -2],
...
# ])
#
# rc_range_parameters_12_10 = np.array([
#     [0, 2, 0],
#     [2, 5, 0],
#     [3, 7, 0],
#     [4, 8, -2],
...
# ])
#
# rc_range_parameters_12_12 = np.array([
#     [0, 6, 2],
#     [4, 9, 2],
#     [7, 11, 0],
#     [8, 12, -2],
...
PPS["bits_per_pixel"] = bits_per_pixel << 4
...
def compute_maxoffset(pixelsPerGroup, groupsPerLine, initial_xmit_delay, bits_per_pixel, first_line_bpg_offset, second_line_bpg_offset, slice_bpg_offset, nfl_bpg_offset, nsl_bpg_offset, native_420):
